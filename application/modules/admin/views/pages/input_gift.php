            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <?php echo form_open_multipart('http://localhost/MG/admin/gift/insert'); ?>
                        ...
                        <div class="row box-body">
                            <div class="col-md-4"><span style="color:red">* </span>File</div>
                        ...
                        <div class="row box-body">
                            ...
                            <div class="col-md-8"><input type="text" id="point" name="point" value="<?php echo set_value('point') ?>"/></div>
                        </div>
                        <div class="row box-body">
